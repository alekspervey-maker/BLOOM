...
const plants = [
  ...
  { 
    ...
    name: 'Переския', 
    emoji: '🌿', 
    image: 'images/pereskia.png', 
    price: 750, 
    category: ['rare', 'foliage'], 
    badge: null, 
    short: 'Редкий «листовой» кактус с настоящими листьями.', 
    desc: 'Единственный кактус, который не стесняется зелени: глянцевые листья, тонкие стебли и колючки в ареолах. Цветёт нежными розовыми или белыми цветами, похожими на дикие розы. Необычный, графичный и очень декоративный — сразу привлекает внимание в коллекции.', 
    care: ['Свет: яркий рассеянный, допустимо немного прямого солнца',
    'Полив: умеренный, после просыхания верхнего слоя почвы',
    'Влажность: средняя',
    'Температура: 18–28 °C'] 
  },
  { 
    ...
    name: 'Калатея «Фредди»', 
    emoji: '🌿', 
    image: 'images/kalateya.png', 
    price: 500, 
    category: ['foliage', 'air'], 
    badge: null, 
    short: 'Изящные удлинённые листья с тёмно-зелёными полосками.', 
    desc: 'Элегантная и графичная: светло-зелёный фон пересекают чёткие тёмные полосы, будто нарисованные тонкой кистью. Смотрится спокойно, стильно и очень декоративно — сразу добавляет в интерьер ощущение свежести и порядка.', 
    care: ['Свет: яркий рассеянный или лёгкая полутень',
    'Полив: регулярный, почва должна оставаться слегка влажной',
    'Влажность: высокая (60–80 %)',
    'Температура: 18–26 °C'] 
  },
  { 
    id: 40, 
    name: 'Хомаломена «Камуфляж»', 
    emoji: '🌿', 
    image: 'images/homalomen.png', 
    price: 1450, 
    category: ['easy', 'foliage', 'air'], 
    badge: null, 
    short: 'Крупные листья с хаотичными пятнами в камуфляжной расцветке.', 
    desc: 'Эффектная и живая: широкие овальные листья покрыты размытыми пятнами разных оттенков зелёного — будто настоящий камуфляж. Смотрится стильно и необычно, сразу становится ярким акцентом в интерьере.', 
    care: ['Свет: яркий рассеянный или лёгкая полутень',
    'Полив: регулярный, почва должна оставаться слегка влажной',
    'Влажность: средняя–высокая',
    'Температура: 18–26 °C'] 
  ...
  { 
    ...
    name: 'Нолина', 
    emoji: '🌿', 
    image: 'images/nolina.png',
    price: 4000, 
    category: ['easy', 'foliage'], 
    badge: null, 
    short: 'Экзотическое «бутылочное» деревце с каскадом длинных листьев.', 
    desc: 'Характерная и очень декоративная: утолщённый ствол-«бутылка» и пышная крона из тонких длинных листьев, будто конский хвост. Смотрится стильно, необычно и сразу добавляет в интерьер ощущение пустынной экзотики.',
    care: ['Свет: яркий, можно прямое солнце',
    'Полив: редкий, после полного просыхания почвы',
