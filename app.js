...
const plants = [
  {
    ...
    emoji: '🌿',
    image: 'images/Ring of Fire.jpg',   // ← путь к фото (положи файл в папку images/)
    price: 1200,
    category: ['foliage'],
    badge: null,
    short: 'Коллекционный сорт',
    desc: 'Яркий представитель филодендрона с непредсказуемой вариегатностью.',
  ...
  },
  {
    ...
    emoji: '🍃',
    image: 'images/Anthurium Renaissance.jpg',
    price: 6500,
    category: ['rare', 'air'],
    badge: 'Новинка',
    short: 'Редкий коллекционный сорт',
    desc: 'Каждый экземпляр уникален, одинаковых листьев не существует.',
  ...
  },
  {
    ...
    badge: 'Новинка',
    short: 'Редкий коллекционный сорт',
    desc: 'Милое имя — серьёзный характер: растёт уверенно и сразу становится любимцем коллекции.',
  ...
  },
  {
    ...
    desc: 'Для тех, кто собирает особенные растения и любит, когда интерьер «светится» даже днём.',
